...
class Finish extends Component {
  render() {
    ...
    if (
      this.props.credit === "Fair" ||
      this.props.credit === "Poor" ||
      this.props.history !== "Has never been in bankruptcy"
    ) {
      message =
      ...
      if (this.props.loanType === "Home Purchase") {
        if (this.props.propToBeUsedOn === "Primary Home") message += "Steve ";
        else message += "Jan ";
      } else message += "our corporate lending offices ";
    ...
    return (
      <div className='parent-div'>
        <div className='vert-align'>
          <p name='promptText'>Thank you for choosing Home Loan Wizard.</p>{" "}
          <br />
          <div>
            <span>
              Please resubmit for an accurate review. The application is missing
